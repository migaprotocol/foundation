import { Users, Globe, Shield, BookOpen, Briefcase, Heart, Linkedin, Instagram, ExternalLink } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-16">
                  ...
                  <div className="flex gap-2 mt-3">
                    {member.links.website && (
                      <a href={member.links.website} target="_blank" rel="noopener noreferrer"
                         className="p-2 rounded-full bg-slate-700/50 hover:bg-amber-500/20 transition">
                        <ExternalLink size={14} className="text-gray-400 hover:text-amber-400" />
                      </a>
                    )}
                    {member.links.linkedin && (
                      <a href={member.links.linkedin} target="_blank" rel="noopener noreferrer"
                         className="p-2 rounded-full bg-slate-700/50 hover:bg-amber-500/20 transition">
                        <Linkedin size={14} className="text-gray-400 hover:text-amber-400" />
                      </a>
                    )}
                    {member.links.instagram && (
                      <a href={member.links.instagram} target="_blank" rel="noopener noreferrer"
                         className="p-2 rounded-full bg-slate-700/50 hover:bg-amber-500/20 transition">
                        <Instagram size={14} className="text-gray-400 hover:text-amber-400" />
                      </a>
                    )}
                  </div>
                )}
          ...
          <p className="text-gray-500 text-sm mt-6 text-center italic">
            Additional board member profiles will be published as operational security permits.
