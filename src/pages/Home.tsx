...
export function Home() {
  return (
    <div className="min-h-screen bg-[#07070A] text-white">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-[#FFD700] to-[#FFA500] text-black font-bold rounded-full hover:shadow-xl hover:shadow-[#FFD700]/30 transition-all text-lg"
            >
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {[
                ...
                { icon: FileText, label: 'Limited News Access' },
                { icon: Film, label: 'Cultural Repression' },
              ].map((item) => (
                <div key={item.label} className="flex flex-col items-center gap-3 p-6 rounded-2xl bg-white/[0.02] border border-white/5">
      ...
      <section className="py-24 bg-gradient-to-b from-[#0A0A12] to-[#07070A]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            {[
              ...
              <div key={feature.title} className="flex gap-5 p-8 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-[#FFD700]/20 transition-all">
      ...
      <section id="token" className="py-24 border-t border-white/5">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              <div key={phase.phase} className="relative p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-[#FFD700]/20 transition-all">
                {/* Connector line */}
                {index < 3 && (
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-5 gap-4 mb-12">
            {[
              ...
              <div key={item.step} className="relative p-6 rounded-2xl bg-white/[0.02] border border-white/5 text-center">
                {/* Step number */}
          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {['Low Fees', 'Fast Voting', 'Global Access', 'Transparent Treasury', 'Real-time Governance'].map((item) => (
                <span key={item} className="px-4 py-2 rounded-full bg-white/[0.03] border border-white/10 text-sm text-gray-300">
                  {item}
                </span>
              ))}
            </div>
      ...
      <section className="py-24 border-t border-white/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            href="https://migaprotocol.xyz"
            className="inline-flex items-center justify-center gap-2 px-12 py-5 bg-gradient-to-r from-[#FFD700] to-[#FFA500] text-black font-bold rounded-full hover:shadow-xl hover:shadow-[#FFD700]/30 transition-all text-xl"
          >
            Join MIGA Today <ArrowRight size={24} />
          </a>
        </div>
      </section>
